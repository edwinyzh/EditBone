...
type
  ...
  private
    ...
    procedure GotoLine(SynEdit, SynEditMiniMap: TBCSynEdit);
...
procedure TDocTabSheetFrame.GotoLine(SynEdit, SynEditMiniMap: TBCSynEdit);
begin
...
begin
  GotoLine(SynEdit, SynEditMiniMap);
end;
...
begin
  GotoLine(SplitSynEdit, SplitSynEditMiniMap);
end;
