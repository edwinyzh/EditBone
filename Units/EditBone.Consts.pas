...
const
  ...
  { Directory tab sheet item tags }
  EDITBONE_DIRECTORY_DRIVE_COMBOBOX_TAG = 0;
  EDITBONE_DIRECTORY_FILE_TREE_VIEW_TAG = 1;
  EDITBONE_DIRECTORY_FILE_TYPE_COMBOBOX_TAG = 2;
