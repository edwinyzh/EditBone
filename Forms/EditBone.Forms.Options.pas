...
uses
  ...
  BCCommon.Options.Container.SQL.Formatter, EditBone.Frames.Options.Editor.Tabs,
  BCCommon.Frames.Options.Editor.CompletionProposal,
  BCCommon.Frames.Options.Editor.Caret, BCCommon.Frames.Options.Editor.CodeFolding, BCCommon.Frames.Options.Editor.MatchingPair,
  ...
  EditBone.Frames.Options.FileTypes, EditBone.Frames.Options.Directory,
  EditBone.Frames.Options.Directory.TabSheet, EditBone.Frames.Options.Output.TabSheet, BCCommon.Frames.Options.Compare,
