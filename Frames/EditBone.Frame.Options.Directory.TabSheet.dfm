inherited OptionsDirectoryTabsFrame: TOptionsDirectoryTabsFrame
  ...
  object Panel: TBCPanel [0]
    ...
    object StickyLabelShowOpenDirectoryButton: TsStickyLabel
      Left = 0
      Top = 142
      Width = 164
      Height = 13
      ...
      Margins.Bottom = 4
      AutoSize = False
      Caption = 'Show open directory button'
      ParentColor = False
      AttachTo = SliderShowOpenDirectoryButton
      Gap = 8
    end
    ...
    object SliderShowOpenDirectoryButton: TsSlider
      Left = 172
      Top = 138
      Width = 50
      AutoSize = True
