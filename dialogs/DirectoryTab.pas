...
uses
  ...
  Vcl.Controls, Vcl.Forms, BCDialogs.Dlg, Vcl.Mask, Vcl.StdCtrls, BCControls.BCEdit, Vcl.ActnList, Vcl.ExtCtrls,
  Vcl.Themes, BCControls.BCCheckBox, Vcl.Buttons, System.Actions, JvExStdCtrls, JvEdit;
